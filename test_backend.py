...
if __name__ == "__main__":
    ...
    # # query = f'LLM("Given the above paper abstract, answer whether the sentiment is "positive" or "negative". Respond ONLY with "positive" or "negative", in all lower case.\n") == "positive"'
    ...
    # # query = f'LLM("Is this a survey or review paper?\n") == "yes"'
    # # query = f'LLM("Given the above paper abstract, answer whether the paper is written in English. Respond ONLY with "yes" or "no", in all lower case.\n") == "yes"'
    # api.analyse(query)
    # 0.5 -> 0.88
    ...
    # query = f'sentiment == "positive" and LLM("Given the above film review, answer whether it contains names. Respond ONLY with "yes" or "no", in all lower case.\n") == "yes"'
    query = f'LLM("Given the above film review, answer whether the sentiment of review is negative and the content is compliant. Respond ONLY with "yes" or "no", in all lower case.\n") == "yes"'
